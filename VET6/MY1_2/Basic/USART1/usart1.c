...
static uint8_t SendBuff[DEBUG1_TX_BSIZE];
static uint8_t ReadBuff[DEBUG1_RX_BSIZE];
...
//DMA----------
volatile static u8 uart1_sending = 0;
//开始发送
...
//	while(DMA_GetFlagStatus(DEBUG1_UART_Tx_DMA_FLAG) == RESET){;}
		while(uart1_sending);
